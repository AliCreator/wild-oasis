...
function CheckinBooking() {
  ...
  useEffect(() => setConfirmCheckin(booking?.isPaid), [booking]);
  ...
  const optionalCost = settings?.breakfastPrice * numGuests * numNights;
  ...
  function handleCheckin() {
    ...
    if (addBreakfast) {
      checkin({
        ...
        breakfast: {
          hasBreakfast: true,
          extraPrice: optionalCost,
          totalPrice: totalPrice + optionalCost,
        },
      });
    } else {
    ...
    <>
      ...
      {!hasBreakfast && (
        <Box>
          ...
          >
            Do you want to add breakfast for {formatCurrency(optionalCost)}?
          </Checkbox>
        </Box>
      )}
      <Box>
        <Checkbox
          ...
          id="confirm"
          disabled={confirmCheckin || isCheckin}
        >
          I confirm that {guests.fullName} has paid the total amount of{" "}
          {!addBreakfast
            ? formatCurrency(totalPrice)
            : `${formatCurrency(totalPrice + optionalCost)} (${formatCurrency(
                totalPrice
